...
const CombinedPage = ({ requirePremium, notificationCount })=> {
  ...
  <div
    ...
    style={{
      ...
      borderRadius: 25,
      cursor: "pointer",
      background: activeTab === "applications" ? "#3b82f6" : "transparent",
  ...
  >
    ...
    {appCount > 0 && (
      <span style={{
        background: activeTab === "applications" ? "#fff" : "#ef4444",
        color: activeTab === "applications" ? "#3b82f6" : "#fff",
        borderRadius: 20,
        padding: "2px 8px",
        fontSize: 12,
        fontWeight: "bold"
  ...
  >
    ...
    {approvalCount > 0 && (
      <span style={{
        background: activeTab === "approvals" ? "#fff" : "#ef4444",
        color: activeTab === "approvals" ? "#3b82f6" : "#fff",
        borderRadius: 20,
        padding: "2px 8px",
        fontSize: 12,
        fontWeight: "bold"
